...
func GeneratePrivateKeysNoKeyType(mnemonic string, hdPaths string) (string, error) {
	...
	privateKeyManager, err := key.GetPrivateKeyManagerByRand(m44H526H1H0H0PrivateKey.Key, key.ED25519)
	if err != nil {
		return "", err
	}
